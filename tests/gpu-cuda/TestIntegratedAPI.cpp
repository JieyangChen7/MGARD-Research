...
#include "mgard/mgard_cuda_api.h"
...
int main(int argc, char *argv[]) {
  ...
  mgard_cuda::compress(shape, mgard_cuda::Double, tol, s, mgard_cuda::REL, 
                in_buff, compressed_data, out_size, config);
  mgard_cuda::decompress(shape, mgard_cuda::Double,
                compressed_data, out_size, (void*)mgard_out_buff);
