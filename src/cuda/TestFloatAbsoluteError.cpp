...
int main(int argc, char *argv[]) {
  ...
  if (D == 1) {
    if (device == 0) {
      ...
      mgard::CompressedDataset<1, float> compressed_dataset = mgard::compress(hierarchy, in_buff, s, tol);
    ...
    if (device == 0) {
      ...
      mgard::CompressedDataset<2, float> compressed_dataset = mgard::compress(hierarchy, in_buff, s, tol);
      out_size = compressed_dataset.size();
    ...
    if (device == 0) {
      ...
      mgard::CompressedDataset<3, float> compressed_dataset = mgard::compress(hierarchy, in_buff, s, tol);
      out_size = compressed_dataset.size();
    ...
    if (device == 0) {
      ...
      mgard::CompressedDataset<4, float> compressed_dataset = mgard::compress(hierarchy, in_buff, s, tol);
      out_size = compressed_dataset.size();
